...
class testTriangleClassify {
    ...
    void testTriangle1(){
        ...
        String result = TriangleClassiy.triangleTest(2,2,2);
    ...
    void testTriangle2(){
        ...
        String result = TriangleClassify.triangleTest(2,2,3);
        assertEquals(expected,result);
    }
    ...
    void testTriangle3(){
        ...
        String result = TriangleClassify.triangleTest(3,4,5);
        assertEquals(expected,result);
    }
    ...
    void testTriangle4(){
        ...
        String result = TriangleClassify.triangleTest(8,2,3);
        assertEquals(expected,result);
    }
    ...
    void testTriangle5(){
        ...
        String result = TriangleClassify.triangleTest(-1,2,1);
        assertEquals(expected,result);
    }
    ...
    void testTriangle6(){
        ...
        String result = TriangleClassify.triangleTest(0,1,1);
        assertEquals(expected,result);
    }
